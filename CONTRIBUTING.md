  ...
  "Projects": [
    {
      ...
      "Type": "Patch",
      "ChangelogMessages": ["Fixed an issue causing a failure somewhere"]
    }
  ]
}
```
...
```
autover change --project-name "AWS.AgentCore.Hosting" -m "Fixed an issue causing a failure somewhere
```
